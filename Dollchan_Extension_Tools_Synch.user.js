// ==UserScript==
// @name            Dollchan Extension Tools Syn-ch 2.0
// @version         15.1.28.0
...
(function de_main_func_inner(scriptStorage, FormData) {
        ...
        var readCfg = regeneratorRuntime.mark(function readCfg() {
                ...
                return regeneratorRuntime.wrap(function readCfg$(context$2$0) {
                        while (1) switch (context$2$0.prev = context$2$0.next) {
                                case 0:
                                        return context$2$0.delegateYield(getStoredObj("Rainbow_Config"), "t4", 1);
                                ...
                                case 1:
                                        ...
                                        if (Cfg.openImgs === 1 && Cfg.openGIFs === 1) {
                                                        Cfg.preLoadImgs = 1;
                                                }
                                        if (!Cfg.saveSage) {
                                                Cfg.sageReply = 0;
                                        ...
                                        if (!Cfg.passwValue) {
                                                ...
                                                locStorage.Rainbow_Pass = Cfg.passwValue;
                                                locStorage.password = Cfg.passwValue;
                                        }
                                        if (!Cfg.stats) {
                                        ...
                                        setStored("Rainbow_Config", JSON.stringify(val));
                                        lang = Cfg.language;
                                        if (Cfg.correctTime) {
        ...
        var version = "15.1.28.0",
            defaultCfg = {
                ...
                language: 0,
                hideBySpell: 0,
                spells: "[1428793695440,[],[[\"\",\"\",\"/(post reply row)([\\\\s\\\\S]{10,250}\\\"name\\\">Какойнибудьнейм)/g\",\"$1 nsfwp $2\"],[\"\",\"\",\"/(<span class=\\\"postfilename\\\" title=\\\"[^>]*?(?:какойнибудьтег1|какойнибудьтег2)[^<]*?</span>.*?<img class=\\\"post-image)/ig\",\"$1 nsfw\"]],false]",
                sortSpells: 0,
                menuHiddBtn: 1,
                hideRefPsts: 0,
                delHiddPost: 0,
                ...
                timeRPattern: "(_w _d _m _Y, _h:_i:_s)",
                expandImgs: 2,
                imgNavBtns: 0,
                resizeDPI: 0,
                resizeImgs: 1,
                ...
                scriptStyle: 0,
                userCSS: 1,
                userCSSTxt: ".de-video-obj {display: inline;}\n.de-video-resizer:after {font-weight:bold; font-size:18px;}\n.de-video-obj > a {display: inline;}\n\n#de-qarea-toggle {font-size:14px;}\n#de-qarea-close {font-size:14px;}\n\n#navigation {display: none;}\n\np.intro time:after{display: none;}\n\na[href=\"mailto:sage\"]:after, a[href=\"mailto:Sage\"]:after, a[href=\"mailto:SAGE\"]:after, a[href=\"mailto:#random\"]:after, a[href=\"mailto:#Random\"]:after, a[href=\"mailto:#RANDOM\"]:after {\ncontent: \"\" !important;}\n\ndiv.post {max-width: 120% !important;}\n\n\ndiv.post img.post-image.nsfw:hover {\ntransition: -webkit-filter, opacity 1s;\ntransition-delay:0.2s;\noutline: 2px dashed rgba(0, 0, 0, 0.0);\nopacity: 0.5;\n-webkit-filter: grayscale(00%);}\n\ndiv.post img.post-image.nsfw {\noutline: 2px dashed rgba(0, 0, 0, 1.5);\noutline-offset:2px;\nopacity: 0.04;\n-webkit-filter: grayscale(100%);}\n\n.nsfwp:hover {\ntransition: -webkit-filter, opacity 1s;\ntransition-delay:0.2s;\noutline: 2px dashed rgba(0, 0, 0, 0.0);\nopacity: 0.5;\n-webkit-filter: grayscale(00%);}\n\n.nsfwp {\noutline: 2px dashed rgba(0, 0, 0, 1.5);\noutline-offset:2px;\nopacity: 0.07;\n-webkit-filter: grayscale(100%);}\n",
                expandPanel: 0,
                attachPanel: 1,
                panelCounter: 0,
                rePageTitle: 1,
            ...
            Lng = {
                ...
                expImgFull: ["", "[Click] expand by center, [Ctrl+Click] in post"],
        ...
        function saveComCfg(dm, obj) {
                spawn(getStoredObj, "Rainbow_Config").then(function (val) {
                        if (obj) {
                                val[dm] = obj;
                        } else {
                                delete val[dm];
        ...
        PostForm.prototype = Object.defineProperties({
                ...
                _init: function _init() {
                        ...
                        this.setReply(false, !TNum || Cfg.addPostForm > 1);
                        el = this.qArea;
                        el.insertAdjacentHTML("beforeend", "<div id=\"de-resizer-top\"></div>" + "<div" + (Cfg.hangQReply ? " class=\"de-cfg-head\"" : "") + ">" + "<span id=\"de-qarea-target\"></span>" + "<span id=\"de-qarea-utils\">" + "<span id=\"de-qarea-toggle\" title=\"" + Lng.toggleQReply[lang] + "\">[Переместить]</span>" + "<span id=\"de-qarea-close\" title=\"" + Lng.closeQReply[lang] + "\">[Закрыть]</span>" + "</span></div>" + "<div id=\"de-resizer-left\"></div>" + "<div id=\"de-resizer-right\"></div>" + "<div id=\"de-resizer-bottom\"></div>");
...
/*                                              return getJsonPosts("/" + brd + "/res/" + TNum + ".json");
 */
                                        case 3:
        ...
        function getImageBoard(checkDomains, checkOther) {
                ...
                var ibDomains = Object.defineProperties({
                        ...
                        "syn-ch.ru": [{
                                ...
                                /* fixFileInputs: { value: function value(el) {
                                        ...
                                        css: { value: ".fileinfo { width: 250px; }\t\t\t\t.multifile { width: auto !important; }\t\t\t\t.post-btn { display: block !important; }" },
                                init: { value: function value() {
                                                if (locStorage.file_dragdrop === "true") {
                                                        locStorage.file_dragdrop = false;
                                                        window.location.reload();
                                ...
                                multiFile: { value: true },
                                init: { value: function value() {
                                                var val = "{\"ajax\":false,\"simpleNavbar\":true,\"showInfo\":true,\"updateFrequency\":\"\",\"hideLongTextNum\":\"\",\"ajax\":false,\"noRefresh\":false,\"externalPolling\":true,\"newTab\":true,\"inline\":false,\"lightbox\":false,\"stickyForm\":false,\"bottomForm\":false,\"quickReply\":false,\"defaultForm\":true,\"inlineForm\":false,\"postHover\":false,\"postHoverOld\":false,\"postHoverDisabled\":true,\"growlEnabled\":false,\"growlPositionY\":\"top\",\"growlPositionX\":\"left\",\"backLinksStyle\":false,\"updateThread\":false,\"showNewMessages\":false,\"imageHover\":false,\"boopNewMessages\":false,\"showBackLinks\":false,\"quoteSelection\":false,\"useLocalTime\":false,\"useMomentJS\":false,\"noko50clear\":false,\"hideImageLinks\":false,\"hidePosts\":false,\"hidePostsMD5\":false,\"showSpoiler\":true,\"previewWebm\":false,\"neverOpenSpoiler\":false,\"textSpoiler\":false,\"hideRoleplay\":false,\"markupButtons\":true,\"markupHotkeys\":false,\"simpleForm\":false,\"textCountForm\":true,\"autoResizeForm\":false,\"showFormOnCite\":false,\"snowfall\":false,\"forcedAnon\":false,\"useAnimateCSS\":false,\"hideLongText\":false,\"version\":9,\"hideImages\":false}";
                                                if (locStorage.settings !== val && locStorage.Rainbow_settingsVersion !== "1") {
                                                        locStorage.settings = val;
                                                        locStorage.Rainbow_settingsVersion = "1";
                                                        locStorage.dollScriptNotice = "shown";
                                                        window.location.reload();
                                                }
                                                if (locStorage.Rainbow_Pass && locStorage.Rainbow_Pass !== locStorage.password) {
                                                locStorage.password = locStorage.Rainbow_Pass;
                                                }
                                        } },
                ...
                var ibEngines = Object.defineProperties({
                        ...
                        "form[name*=\"postcontrols\"]": {
                                ...
                                cssEn: { value: ".banner, " + (TNum ? "" : ".de-btn-rep1,") + " .hide-thread-link, .mentioned, .post-hover { display: none !important; }\n\t\t\t\tdiv.post.reply { float: left; clear: left; display: block; }\n\t\t\t\tform, form table { margin: 0; }" },
                ...
                var ibBase = Object.defineProperties({
                        ...
                        getThrdUrl: function getThrdUrl(b, tNum) {
                                return this.prot + "//" + this.host + fixBrd(b) + this.res + tNum + this.docExt + "?nocache=" + Math.random();
                        },
...
function replacePost(el) {
  ...
  tmp.innerHTML = replaceString(el.outerHTML);
